...
if __name__ == '__main__':
    ...
    is_added = block_chain.add_transaction(wallet_A.blockchain_address, wallet_B.blockchain_address,
                                           1.0, wallet_A.public_key, t.generate_signature())
    print('Added?', is_added)
    block_chain.mining()
    utils.pprint(block_chain.chain)

    print('A', block_chain.caluculate_total_amount(wallet_A.blockchain_address))
    print('B', block_chain.caluculate_total_amount(wallet_B.blockchain_address))
